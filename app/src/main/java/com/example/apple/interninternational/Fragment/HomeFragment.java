...
public class HomeFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        fragmentMainView = inflater.inflate(R.layout.frag_home_screen,container,false);
        initialiseUi();
    ...
    public void initialiseUi() {
        internationalCard = (CardView) fragmentMainView.findViewById(R.id.frag_home_screen_inter_card);
        nationalCard = (CardView) fragmentMainView.findViewById(R.id.frag_home_screen_nation_card);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.frag_home_screen_inter_card) {
            Toast.makeText(getContext(),"International Card",Toast.LENGTH_SHORT).show();
        }
        else if (v.getId() == R.id.frag_home_screen_nation_card) {
