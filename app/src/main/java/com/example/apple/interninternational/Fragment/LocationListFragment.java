...
public class LocationListFragment extends Fragment {
    ...
    private void initialiseUi() {
        ...
        FilterInputsAdapter adapter = new FilterInputsAdapter(HomeScreen.HOMESCREEN_REFERENCE.getBaseContext(), NationalFragUtils.getLocations(),"Location",R.layout.custom_location_cell);
